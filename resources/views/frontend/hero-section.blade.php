{{-- <div class="carousel w-full">
    <div id="slide1" class="carousel-item relative w-full">
        <img src="assets/gambar/hero.webp" class=" lg:h-screen h-64 w-full" />
        <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
            <a href="#slide4" class="btn btn-circle bg-transparent border-0 ">❮</a>
            <a href="#slide2" class="btn btn-circle bg-transparent border-0 ">❯</a>
        </div>
    </div>
    <div id="slide2" class="carousel-item relative w-full">
        <img src="https://img.daisyui.com/images/stock/photo-1609621838510-5ad474b7d25d.webp" class="w-full" />
        <div class="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between">
            <a href="#slide1" class="btn btn-circle bg-transparent border-0">❮</a>
            <a href="#slide3" class="btn btn-circle bg-transparent border-0">❯</a>
        </div>
    </div>
...
<div class="carousel w-full relative h-64 lg:h-screen">
    <div id="slide1" class="carousel-item active">
        <img src="assets/gambar/hero.webp" class="w-full h-screen object-cover" />
    </div>
